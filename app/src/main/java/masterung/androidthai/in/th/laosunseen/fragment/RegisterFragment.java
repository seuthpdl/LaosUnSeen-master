...
//        Photo Controller
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode==getActivity().RESULT_OK) {
            ...
            Toast.makeText(getActivity(),"ກະລຸນາເລືອກຮູບ",Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void photoController() {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(Intent.createChooser(intent,"ກະລຸນາເລືອກແອບສະແດງຮູບ"),1);
            }
        });
    }
    ...
    private void createToolbar() {
        ...
        ((MainActivity)getActivity()).getSupportActionBar().setSubtitle("ກະລຸນນາເລືອກຮູບ ແລະປ້ອນຂໍ້ມູນໃຫ້ຄົບ");
...
//        ຂໍອານຸຍາດທູນບາເພື່ອເອົາເມນູໄປໃສ
